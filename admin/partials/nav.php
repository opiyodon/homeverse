		...
		<nav>
            ...
            <menu class="NAV_TOGGLER_MENU /// NAV_TOGGLER_CLOSE">
                <ul>
                    ...
                    <li>
                        <a class="NAV_LI" href="<?php echo SITEURL_ADMIN; ?>manage_admin.php">Admin</a>
                    </li>
                    <li>
                        <a class="NAV_LI" href="<?php echo SITEURL_ADMIN; ?>manage_property.php">Property</a>
                    </li>
                    <li>
                        <a class="NAV_LI" href="<?php echo SITEURL_ADMIN; ?>manage_review.php">Review</a>
                    </li>
                    <li>
                        <a class="NAV_LI" href="<?php echo SITEURL_ADMIN; ?>manage_blog.php">Blog</a>
                    </li>
                    <li>
                        <a class="NAV_LI" href="<?php echo SITEURL_ADMIN; ?>manage_order.php">Order</a>
                    </li>
                    <li>
                        <a class="NAV_LI" target="_blank" href="<?php echo SITEURL_USER; ?>login.php">User</a>
                    </li>
                    <li class="dark-mode">
                        <div class="DAY_NIGHT">
                    ...
                    <?php
                            ...
                            $sql = "SELECT * FROM user WHERE id = $user_id2 ORDER BY id DESC";
                            // Execute the query
                                    ...
                                    while ($rows = mysqli_fetch_assoc($res)) {
                                        ...
                                        <div class="user-icon" onclick="toggleDropdown()">
                                            ...
                                            <div class="dropdown" id="dropdownMenu">
                                                <a class="NAV_LI dropdown-item" href="<?php echo SITEURL_ADMIN; ?>profile.php?id=<?php echo $id; ?>">View Profile</a>
                                                <a class="NAV_LI dropdown-item" href="<?php echo SITEURL_ADMIN; ?>logout.php">Logout</a>
                                            </div>
                                        </div>
