                ...
                <div class="SOCIAL">
                    <a href="#">
                        <div>
                            ...
                            <ion-icon class="contact-icon" name="logo-facebook"></ion-icon>
                    ...
                    <a href="#">
                        <div>
                            ...
                            <ion-icon class="contact-icon" name="logo-twitter"></ion-icon>
                    ...
                    <a href="#">
                        <div>
                            ...
                            <ion-icon class="contact-icon" name="logo-google"></ion-icon>
                    ...
                    <a href="#">
                        <div>
                            ...
                            <ion-icon class="contact-icon" name="logo-linkedin"></ion-icon>
                    ...
                    <a href="#">
                        <div>
                            ...
                            <ion-icon class="contact-icon" name="wifi-outline"></ion-icon>
